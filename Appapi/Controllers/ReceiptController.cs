...
namespace Appapi.Controllers
{
    public class ReceiptController : ApiController
    {
        ...
        [HttpPost]
        public string ReceiveCommitWithNonQRCode(Receipt Para)
        {
        ...
        [HttpPost]
        public string ReceiveCommitWithQRCode(Receipt Para)
        {
        ...
        [HttpPost]
        public string IQCCommit(Receipt para)
        {
        ...
        [HttpPost]
        public string AcceptCommit(Receipt para)
        {
